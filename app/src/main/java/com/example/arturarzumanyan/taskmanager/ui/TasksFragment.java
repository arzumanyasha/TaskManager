...
public class TasksFragment extends Fragment {
    ...
    private ImageView taskDeleteImageView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        taskDescriptionTextView = view.findViewById(R.id.textViewTaskDescription);
        taskDeleteImageView = view.findViewById(R.id.imageViewDelete);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        TasksDbRepository tasksDbRepository = new TasksDbRepository();
        try {
            tasks = tasksDbRepository.getTasksFromTaskList(getActivity(), Integer.parseInt(mParam1));
